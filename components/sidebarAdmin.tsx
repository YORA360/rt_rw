...
import {Home,Calendar,Megaphone,Wallet,Store, Users } from "lucide-react"
...
export default function SideBar(){
    ...
    const menu = [
        {name:"Dasboard", icon: Home, href: "/user/dashboard"},
        {name:"Keluarga", icon: Users, href: "/user/keluarga"},
